...
class bootje:
    def __init__ (self, ship_x, ship_y,steps,length,w,h, rotate_w, rotate_h):
        self.ship_x = ship_x
        self.ship_y = ship_y
        ...
        if self.zetten != self.steps + self.bonus:
            if self.ship_active:
                ...
                if keys[pygame.K_SPACE]:
                    self.w = self.rotate_w
                    self.h = self.rotate_h
                    self.ship_active = False
...
bootje1 = bootje(390, 110,2,2,20,45, 45, 20)
bootje2 = bootje(440, 110,2,3,20,70, 70, 20)
bootje3 = bootje(490, 110,2,3,20,70, 70, 20)
bootje4 = bootje(540, 110,2,4,20,95, 95, 20)

bootje5 = bootje(390, 560,2,2,20,45,  45, 20)
bootje6 = bootje(440, 535,2,3,20,70,  70, 20)
bootje7 = bootje(490, 535,2,3,20,70,  70, 20)
bootje8 = bootje(540, 510,2,4,20,95,  95, 20)
